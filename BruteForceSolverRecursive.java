...
public class BruteForceSolverRecursive {
    ...
    public static long calculateCCTFromJobOrdering(ArrayList<ArrayList<Job>> schedules,
		...
		long potentialWCCT = BruteForceSolverRecursive.calculateCCT(coflowCompletionTime, weights);
        ...
        for (i = 0; i < schedulesSize; i++) {
			...
			newSchedulesIndex[i]++;
			long newWCCT = BruteForceSolverRecursive.calculateCCTFromJobOrdering(schedules,
	...
	public static long getSchedulePermutations(ArrayList<ArrayList<Job>> schedule,
    	...
    	if (index < schedulesSize) {
			for (ArrayList<Job> perm : jobPermutations.get(index)) {
				...
				long newWCCT = BruteForceSolverRecursive.getSchedulePermutations(schedule,
    		...
    		wCCT = BruteForceSolverRecursive.calculateCCTFromJobOrdering(schedule, schedulesSize, wCCT, weights,
	...
	public static long calculateOptimalCCT(ArrayList<ArrayList<Job>> schedules) {
		...
		long wCCT = BruteForceSolverRecursive.getSchedulePermutations(schedule, schedulesSize, 0, -1,
    ...
    public static void main(String [] args) throws Exception {
		...
		long wCCT = BruteForceSolverRecursive.calculateOptimalCCT(schedules);
		return;
    }
}
