...
$JAVA_CC BruteForceSolverIterative.java CalculateSchedules.java Job.java -cp .:gen-java/:"lib/*"
mv Job.java LocalJobClass/

echo --- Done, now run your code.
echo     Examples:
echo $JAVA '-cp .:gen-java/:"lib/*" BruteForceSolverIterative schedule.txt'
